...
const Footer = () => {
  return (
    <footer className="py-10 bg-gray-900 text-slate-300 mx-auto px-6 border-t border-accent">
      <div
        id="footerBox"
        className="grid md:grid-cols-4 col-span-1 gap-y-6 md:text-left text-center"
      >
        <div className="pl-4">
          <Link to={`/`} className=" text-xl text-secondary font-semibold">
            Anipedia
          </Link>
          <div id="copyright" className="font-light text-xs py-2">
            © 2024 All rights Reserved by Anipedia
          </div>
        </div>
